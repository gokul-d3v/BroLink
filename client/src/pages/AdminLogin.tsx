        ...
        <div className="min-h-screen w-full bg-[#050505] text-white flex flex-col font-sans selection:bg-purple-500/30">
            ...
            <main className="flex-1 flex items-center justify-center p-4">
                <div className="w-full max-w-5xl">
                    ...
                    >
                        {/* Welcome Widget */}
                        <div key="welcome" className="relative group overflow-hidden">
                            <div className="h-full w-full bg-[#EBF58A] rounded-[32px] p-8 sm:p-10 flex flex-col justify-between text-zinc-900">
                                <div className="drag-handle absolute top-6 right-6 opacity-0 group-hover:opacity-100 transition-opacity cursor-grab active:cursor-grabbing text-zinc-400">
                        ...
                        <div key="email" className="relative group">
                            <div className="h-full w-full bg-[#9ACBE8] rounded-[32px] p-8 flex flex-col text-zinc-900">
                                <div className="drag-handle absolute top-6 right-6 opacity-0 group-hover:opacity-100 transition-opacity cursor-grab active:cursor-grabbing text-zinc-600">
                                    <div className="grid grid-cols-2 gap-1">
                                        <div className="w-1 h-1 bg-current rounded-full"></div>
                                        <div className="w-1 h-1 bg-current rounded-full"></div>
                                        <div className="w-1 h-1 bg-current rounded-full"></div>
                            ...
                            <div className="h-full w-full bg-[#A0E8AF] rounded-[32px] p-6 sm:p-8 flex flex-col justify-center text-zinc-900">
                                ...
                                <div className="relative">
                                    ...
                                    <button
                                        ...
                                        className="absolute right-3 top-1/2 -translate-y-1/2 text-zinc-500 hover:text-zinc-800 transition-colors p-1"
                                    >
                        ...
                        {/* Enter Widget */}
                        <div key="enter" className="relative group">
                            <button
                                onClick={handleLogin}
                                disabled={isLoading}
                                className="h-full w-full bg-[#6200EE] rounded-[32px] flex items-center justify-center relative hover:scale-[1.02] active:scale-[0.98] transition-all group-hover:shadow-[0_0_40px_-10px_rgba(98,0,238,0.5)]"
                            >
                                <div className="drag-handle absolute top-6 right-6 opacity-0 group-hover:opacity-100 transition-opacity cursor-grab active:cursor-grabbing text-white/50 z-20">
                        ...
                        <div key="quick" className="relative group">
                            <div className="h-full w-full bg-[#FFBCB7] rounded-[32px] p-6 sm:p-8 flex flex-col justify-center text-zinc-900">
                                <div className="drag-handle absolute top-6 right-6 opacity-0 group-hover:opacity-100 transition-opacity cursor-grab active:cursor-grabbing text-zinc-600">
                                    <div className="grid grid-cols-2 gap-1">
                                        <div className="w-1 h-1 bg-current rounded-full"></div>
                                        <div className="w-1 h-1 bg-current rounded-full"></div>
